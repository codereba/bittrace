...
//	}
	...
	VOID set_lang_text()
	{
		set_ctrl_text( &m_pm, _T( "common_msg_btn" ), TEXT_RUN_TIME_LOG_COMMON_MSG, _T( "一般系统消息" ) ); 
		set_ctrl_text( &m_pm, _T( "file_msg_btn" ), TEXT_RUN_TIME_LOG_FILE_MSG, _T( "文件行为消息" ) ); 
		set_ctrl_text( &m_pm, _T( "reg_msg_btn" ), TEXT_RUN_TIME_LOG_REG_MSG, _T( "注册表行为消息" ) ); 
		set_ctrl_text( &m_pm, _T( "net_msg_btn" ), TEXT_RUN_TIME_LOG_NETWORK_MSG, _T( "网络通信消息" ) ); 
