...
#ifdef _DRIVER
#define INSTALL_DRV_DESC L"��װ����" 
#define INSTALL_HOOK_DESC L"��װ����" 
#define CREATE_PROC_DESC L"������������" 
#define ACCESS_MEM_DESC L"�������������ڴ�" 
#define ACCESS_COM_DESC L"����COM�������" 
#define MODIFY_KEY_DESC L"�޸�ע�����ֵ" 
#define MODIFY_FILE_DESC L"�޸ı�����Ŀ¼���ļ�" 
#else
#define INSTALL_DRV_DESC _T( "��װ����" )
#define INSTALL_HOOK_DESC _T( "��װ����") 
#define CREATE_PROC_DESC _T( "������������") 
#define ACCESS_MEM_DESC _T( "�������������ڴ�" )
#define ACCESS_COM_DESC _T( "����COM�������")
#define MODIFY_KEY_DESC _T( "�޸�ע�����ֵ")
#define MODIFY_FILE_DESC _T( "�޸ı�����Ŀ¼���ļ�" )
#endif //_DRIVER
