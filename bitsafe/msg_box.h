...
class msg_box : public CWindowWnd, public wnd_state, public INotifyUI
{
public:
	msg_box() 
	{
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        ...
        CControlUI* pRoot = builder.Create(_T("msg_box.xml"), (UINT)0, NULL, &m_pm);
...
INLINE LRESULT show_msg( HWND parent, LPCTSTR msg, dlg_ret_state *ret_state = NULL, LPCTSTR title = NULL, ULONG mode = 0, UINT32 main_icon = NULL )
{
