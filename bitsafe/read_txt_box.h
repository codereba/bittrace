...
class read_txt_box : public CWindowWnd, public wnd_state, public INotifyUI
{
public:
	read_txt_box() 
	{
  ...
  //      m_pCloseBtn = static_cast<CButtonUI*>(m_pm.FindControl(_T("close_btn")));
   ...
   //         }
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        ...
        CControlUI* pRoot = builder.Create( _T( "read_txt_box.xml" ), (UINT)0, NULL, &m_pm);
...
INLINE LRESULT show_txt( HWND parent, LPCTSTR msg, dlg_ret_state *ret_state = NULL, LPCTSTR title = NULL, ULONG mode = 0 )
{
	LRESULT ret = ERROR_SUCCESS; 
	read_txt_box msg_tip; 
	CControlUI *msg_txt; 
	...
	if( NULL == msg_tip.Create( parent, title, UI_WNDSTYLE_DIALOG, 0L, 0, 0, 1024, 738) )
	{
		goto _return; 
	}
	...
	msg_txt = msg_tip.m_pm.FindControl( _T( "txt_edit" ) ); 
