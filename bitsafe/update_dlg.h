	...
	if( prepare_work == PREPARE_BY_RESTART )
	{
		if( ret != ERROR_FILE_NOT_FOUND )
		{
			tmp_text = _get_string_by_id( TEXT_UPDATE_OLD_VERSION_HAVE_NOT_UNINSTALL, 
				_T( "�ɰ汾���ذ�ȫû�����ȫ��ж��,�������г���(�°汾)ʱ,Ҫ��ִ��ж��(����ְ�װ��ʾ,�Ȳ�Ҫִ�а�װ),�ڱ�֤ж��ȫ����ɺ�,�����°�װ�����г���" ) ); 
		...
		tmp_text = _get_string_by_id( TEXT_INSTALL_NEED_RESTART, _T( "����ϵͳ������ԭ��,���ذ�ȫ��Ҫ����ϵͳ����ɰ�װ,�Ƿ���������?" ) ); 
...
#define FILE_DOWNLOAD_TIP_FMT _T( "�ļ� ������ %d/%d" )
	...
	VOID on_update_failed( update_tip_info *tip_info)
	{
			...
			&& *tip_info->err_msg == L'\0' )
		{
			...
			tmp_text = _get_string_by_id( TEXT_UPDATE_UPDATE_FAILED, L"����ʧ��" ); 
		...
		tip_text->SetText( tip_info->err_msg ); //��������������.
_return:
		return; 
	}
...
_return:
	...
	VOID on_update_successful()
	{
		...
		tmp_text = _get_string_by_id( TEXT_UPDATE_UPDATE_SUCCESSFUL, _T( "���³ɹ�" ) ); 
...
_return:
	...
	LRESULT on_file_updated( LPCWSTR file_name )
	{
		...
		tmp_text = _get_string_by_id( TEXT_UPDATE_UPDATING_FILE_NO_TIP, _T( "���ڸ��µ�%d���ļ�%s\n" ) ); 
...
_return:
	...
	LRESULT on_update_starting( update_tip_info *info )
	{
		...
		if( can_update == TRUE )
		{
			...
			tmp_text = _get_string_by_id( TEXT_UPDATE_ALL_FILE_COUNT_TIP, _T( "��ʼ����,����%d���ļ�" ) ); 
