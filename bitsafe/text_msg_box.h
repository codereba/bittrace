...
class text_msg_box: public CWindowWnd, public wnd_state, public INotifyUI
{
public:
	text_msg_box() 
	{
  ...
  //      m_pCloseBtn = static_cast<CButtonUI*>(m_pm.FindControl(_T("close_btn")));
   ...
   //         }
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        ...
        CControlUI* pRoot = builder.Create(_T("text_msg_box.xml"), (UINT)0, NULL, &m_pm);
...
INLINE LRESULT show_text_msg( HWND parent, LPCTSTR msg, dlg_ret_state *ret_state = NULL, LPCTSTR title = NULL, ULONG mode = 0, UINT32 main_icon = NULL )
{
	LRESULT ret = ERROR_SUCCESS; 
	text_msg_box msg_tip; 
	CControlUI *msg_txt; 
	...
	BringWindowToTop( msg_tip.GetHWND() ); 
...
LRESULT dbg_show_text_msg( HWND parent, LPCTSTR msg, LPCTSTR title = NULL, ULONG mode = 0 ); 