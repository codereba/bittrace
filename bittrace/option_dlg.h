...
#else
#define UNINSTALL_NEED_RESTART_TEXT L"���ظ���ж�����,�رճ����ɾ������Ŀ¼���ȫ��ж��"
#define MAIN_BITSAFE_STARTED_BALLOON_TIP_TEXT L"���ظ����Ѿ�����" 
#define RUN_BITTRACE_NEED_RESTART L"���б��ذ�ȫ��Ҫ����ϵͳ." 
#define BITTRACE_SUPPORT_OS_TIP_TEXT L"��ǰBITTRACE֧��32λ,64λ��WINDOWS XP,WINDOWS 2003,WINDOWS VISTA,WINDOWS 7,WINDOWS 2008,WINDOWS2012ϵͳ,��ʱ��֧������ϵͳ��"
#define CONFIG_SYMBOL_CACHE_PATH_TIP_TEXT L"��������ȷ�ķ��ű���Ŀ¼·��"
#define SAVE_COMMON_CONFIG_ERROR_MESSAGE_TEXT L"���渨������ʧ��"
#define SAVE_COMMON_CONFIG_ERROR_MESSAGE_TEXT L"���渨�����óɹ�"
#endif //LANG_EN
		...
		else if( msg.sType == _T( "click" ) ) 
		{
			...
			if( name == _T( "symbol_ok_btn" ) )
			{
				...
				do 
				{
					...
					{
						tmp_text = CONFIG_SYMBOL_CACHE_PATH_TIP_TEXT; //L"��������ȷ�ķ��ű���Ŀ¼·��"; 
