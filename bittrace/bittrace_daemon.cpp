...
LRESULT config_bitsafe()
{
	...
	tmp_text = _get_string_by_id( TEXT_BITSAFE_SETTING_AUTORUN, _T( "���ذ�ȫ�Ƿ���ϵͳ����ʱ�Զ�����?" ) ); 
...
ULONG CALLBACK init_ui_context_thread( PVOID param )
{
	...
	if( ret != ERROR_SUCCESS )
	{
		...
		if( ret != ERROR_USER_CANCEL_INSTALL )
		{
			...
			if( ret == ERROR_SUCCESS )
			{
				tmp_text = _get_string_by_id( TEXT_INSTALL_NEED_RESTART, _T( "ϵͳ��������ȫ������������ذ�ȫ������,����ذ�ȫ�ļ����ƻ�,���������ٴ�����.��������,��ʹ��ԭʼ��װ�����°�װ.������޷�����,�뽫��Ϣ������( email:" ) BITSAFE_EMAIL __t( " bbs:codereba.com/bbs ),�����������,лл." ) ); 
			}
			else
			{

				tmp_text = _get_string_by_id( TEXT_INSTALL_NEED_RESTART, _T( "���ذ�ȫ�ļ����ƻ�,��ʹ��ԭʼ��װ�����°�װ.������޷�����,�뽫��Ϣ������( email:" ) BITSAFE_EMAIL __t( " bbs:codereba.com/bbs ),�����������,лл." ) ); 
			}
