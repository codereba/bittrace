#ifndef __SQLITE32_H__
#define __SQLITE32_H__
...
int sqlite3_set_profile( sqlite3 *db, void (*x_profile)(void*,const char*,unsigned long long), void* param ); 
