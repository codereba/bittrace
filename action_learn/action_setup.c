						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action_info->action.do_exec_create.pid = all_params[ 0 ].data.ptr_val; //Ŀ�����ID 
		action_info->action.do_exec_create.parent_pid = all_params[ 0 ].data.ptr_val; //���������߽���ID 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_exec_module_load.base = all_params[ 0 ].data.uint32_val; //Ŀ�����ID 
		action->action.do_exec_module_load.size = all_params[ 1 ].data.uint32_val; //���������߽���ID 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_exec_destroy.pid = all_params[ 0 ].data.uint32_val; //Ŀ�����ID 
		action->action.do_exec_destroy.parent_pid = all_params[ 1 ].data.uint32_val; //���������߽���ID 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_file_touch.alloc_size = all_params[ 0 ].data.uint32_val; //�ļ���ʼ���� 
		action->action.do_file_touch.attrib = all_params[ 1 ].data.uint32_val; //�ļ����� 
		action->action.do_file_touch.share = all_params[ 2 ].data.uint32_val; //�ļ��������� 
		action->action.do_file_touch.disposition = all_params[ 3 ].data.uint32_val; //�ļ���/����ѡ�� 
		action->action.do_file_touch.options = all_params[ 4 ].data.uint32_val; //�ļ���/����ѡ�� 
		//action->action.do_file_touch.result = all_params[ 5 ].data.uint32_val; //������ɽ��(NTSTATUS) 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_file_open.access = all_params[ 0 ].data.uint32_val; //�ļ�����Ȩ�� 
		action->action.do_file_open.alloc_size = all_params[ 1 ].data.uint32_val; //�ļ���ʼ���� 
		action->action.do_file_open.attrib = all_params[ 2 ].data.uint32_val; //�ļ����� 
		action->action.do_file_open.share = all_params[ 3 ].data.uint32_val; //�ļ��������� 
		action->action.do_file_open.disposition = all_params[ 4 ].data.uint32_val; //�ļ���/����ѡ�� 
		action->action.do_file_open.options = all_params[ 5 ].data.uint32_val; //�ļ���/����ѡ�� 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_file_read.offset = all_params[ 0 ].data.uint32_val; //Ŀ�����ID 
		action->action.do_file_read.data_len = all_params[ 1 ].data.uint32_val; //���������߽���ID 
						   ...
						   ULONG flags )
{
	...
	do 
	{
		...
		action->action.do_file_write.offset = all_params[ 0 ].data.uint32_val; //Ŀ�����ID 
		action->action.do_file_write.data_len = all_params[ 1 ].data.uint32_val; //���������߽���ID 
...
NTSTATUS test_action_data_setup()
{
	...
	do 
	{
		...
		//ULONG pid; // ����ID 
		//ULONG parent_pid; // ������ID 
		//PVOID image_base; //process virtual address space // ��ӳ���ַ 
		//PATH_SIZE_T path_len; 
		//PATH_SIZE_T cmd_len; 
		//union 
		//{
