	...
	LRESULT on_init_dlg( UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled )
	{
		...
		if (pSysMenu != NULL)
		{
			...
			if (!strAboutMenu.IsEmpty())
			{
				...
				pSysMenu.AppendMenu( MF_STRING, ( UINT_PTR )IDM_INSTALL, ( LPCTSTR )"��װ7�����ǽ(&I)" );
				pSysMenu.AppendMenu( MF_STRING, ( UINT_PTR )IDM_UNINSTALL, ( LPCTSTR )"ж��7�����ǽ(&U)" );
