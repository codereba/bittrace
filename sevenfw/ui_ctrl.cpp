...
/******************************************************************************************
�����ļ����Լ��ķ���:
1.ͨ��IO CTL�����õ�DRIVER�İ汾��
2.���а汾�ż�飬������Ӧ�ò���Ӧ�İ汾��һ�²�������,����֪ͨ�û������������������,����ж�ء�
3.�����ļ��ݰ汾��ֻ������Ӧ�ò��ͨ�ŷ�ʽ�����ݷ����仯ʱ���Ÿı䡣
******************************************************************************************/
...
INLINE LRESULT init_anti_arp( PVOID context, PVOID param )
{
	...
	if( ret != ERROR_SUCCESS )
	{
		...
		if( ret != ERROR_SUCCESS )
		{
#define ANTI_ARP_NEED_RESTART_TIP _T( "����ϵͳ����ԭ��,��ARP�����޷���������,��Ҫϵͳ����,�Ƿ���������?" )
...
LRESULT WINAPI lite_work( ULONG flags, PVOID context, PVOID param )
{
	...
	do 
	{
		...
		if( ret == ERROR_SUCCESS )
		{
			...
			if( ret != ERROR_SUCCESS )
			{
				_ret = notify_error_msg( L"BITTRACE�����汾�Ѿ�����,����ϵͳ��������ǰ�汾." ); 
				exit( 0 ); 
				break; 
			}
