...
{
    return UI_ACTIVEX_CLASS_NAME;
}

ULONG CActiveXUI::GetClassId() const
{
	return UI_ACTIVEX_CLASS_ID;
}

LPVOID CActiveXUI::GetInterface(LPCTSTR pstrName)
{
	if( _tcscmp(pstrName, UI_ACTIVEX_INTERFACE_NAME) == 0 ) return static_cast<CActiveXUI*>(this);
